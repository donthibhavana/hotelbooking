...
<div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                 <h2 style="text-align: center;">Rooms Price In Low-High</h2>
                 ...
                 <table class="table table-stripped table-bordered">
                        ...
                        $sql = "SELECT city.name,room.rid,room.roomnumber,room.type,room.beds,room.image,room.price,hotel.hname,hotel.address FROM `room` join hotel on room.hid=hotel.hid JOIN city on hotel.city_id=city.city_id where city.name='$c' order by price asc";
